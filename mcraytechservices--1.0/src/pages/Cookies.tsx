  ...
  return (
    <>
      <div className="container py-10 md:py-16 min-h-screen bg-background text-foreground">
        ...
        <h3 className="mb-4 text-xl font-semibold">What are cookies?</h3>
        <p className="mb-4 text-md text-muted-foreground leading-relaxed">
        ...
        <p className="mb-4 text-md text-muted-foreground leading-relaxed">
          Cookies set by the website owner (in this case, McRay Tech Services
          Ltd) are called "first-party cookies." Cookies set by parties other
        ...
        <h3 className="mb-4 text-xl font-semibold">Why do we use cookies?</h3>
        <p className="mb-4 text-md text-muted-foreground leading-relaxed">
        ...
        <p className="mb-4 text-md text-muted-foreground leading-relaxed">
          ...
          like web beacons (sometimes called{" "}
          <b>"tracking pixels" or "clear gifs"</b>). These are tiny graphics
          files that contain a unique identifier that enables us to recognize
          when someone has visited our Website or opened an email including
          them. This allows us, for example, to monitor the traffic patterns of
