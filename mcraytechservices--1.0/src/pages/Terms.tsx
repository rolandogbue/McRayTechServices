    ...
    <>
      <div className="container py-10 md:py-16 min-h-screen bg-background text-foreground">
        ...
        <p className="mb-4 text-md text-muted-foreground leading-relaxed">
          We are McRay Tech Services Ltd (<b>"Company," "we," "us," "our"</b>).
        </p>
        <p className="mb-4 text-md text-muted-foreground leading-relaxed">
          We operate , as well as any other related products and services that
          refer or link to these legal terms (the <b>"Legal Terms"</b>)
        ...
        <p className="mb-4 text-md text-muted-foreground leading-relaxed">
          ...
          or by mail to McRay Tech Services Ltd, BLK C40 NAHS KURUDU II, . Und
          St. Gidan Mangoro,  Abuja, FCT 900109.
        </p>
        <p className="mb-4 text-md text-muted-foreground leading-relaxed">
          These Legal Terms constitute a legally binding agreement made between
          you, whether personally or on behalf of an entity ("you"), and McRay
          Tech Services Ltd, concerning your access to and use of the Services.
        ...
        <ol className="list-decimal list-inside mb-6 text-md text-muted-foreground leading-relaxed">
          ...
          <a className="text-primary underline" href="#content15">
            <li> INDEMNIFICATION</li>
          </a>
          <a className="text-primary underline" href="#content16">
            <li> USER DATA</li>
          </a>
          <a className="text-primary underline" href="#content17">
            <li>ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</li>
          </a>
          <a className="text-primary underline" href="#content18">
            <li>MISCELLANEOUS</li>
          </a>
          <a className="text-primary underline" href="#content19">
            <li>CONTACT US</li>
          </a>
        </ol>
        ...
        <ul className="list-disc pl-12 mb-6 text-md text-muted-foreground leading-relaxed">
          <li>access the Services; and</li>
          <li>
            download or print a copy of any portion of the Content to which you
            have properly gained access, <br />
          </li>
        </ul>
        <p className="mb-4 text-md text-muted-foreground leading-relaxed">
        ...
        <p className="mb-4 text-md text-muted-foreground leading-relaxed">
          ...
          <a href="mailto:support@mcraytechservices.com">
            support@mcraytechservices.com
          </a>
        ...
        <p className="mb-4 text-md text-muted-foreground leading-relaxed">
          ...
          upload any content <br /> through the Services.
        </p>
        <p className="mb-4 text-md text-muted-foreground leading-relaxed">
        ...
        <ul className="list-disc mb-6 text-md text-muted-foreground leading-relaxed pl-12">
          <li>
            ...
            person or group, sexually <br /> explicit, false, inaccurate,
        ...
        <ul className="list-disc pl-12 mb-4 text-md text-muted-foreground leading-relaxed">
          <li>
          ...
          <li>
            ...
            interchange <br /> formats (<b>"gifs"</b>), 1×1 pixels, web bugs,
            cookies, or other similar devices (sometimes referred to as{" "}
            <b>"spyware" or "passive collection mechanisms" or "pcms"</b>).
          </li>
          <li>
          ...
          <li>
            ...
            utility, scraper, or <br /> offline reader that accesses the
        ...
        <p className="mb-4 text-md text-muted-foreground leading-relaxed">
          ...
          <b>"Contributions"</b>). Contributions may be viewable by other users
          of the Services and through third-party websites. When you create or
        ...
        <p className="mb-4 text-md text-muted-foreground leading-relaxed">
          ...
          of the Federal Republic of Nigeria. The Federal Republic of Nigeria
          and yourself irrevocably consent that the courts of the Federal
          Republic of Nigeria shall have exclusive jurisdiction to resolve any
        ...
        <p className="mb-4 text-md text-muted-foreground leading-relaxed">
          ...
          be one (1). The seat, or legal place, of arbitration shall be Abuja,
          Nigeria. The language of the proceedings shall be English. The
          governing law of these Legal Terms shall be the substantive law of the
        ...
        <p className="mb-4 text-md text-muted-foreground leading-relaxed">
          ...
          concerning informal negotiations binding arbitration: (a) any Disputes
        ...
        <h3 id="content15" className="mb-4 text-xl font-semibold">
          15. INDEMNIFICATION
        </h3>
        <p className="mb-4 text-md text-muted-foreground leading-relaxed">
        ...
        <h3 id="content16" className="mb-4 text-xl font-semibold">
          16. USER DATA
        </h3>
        <p className="mb-4 text-md text-muted-foreground leading-relaxed">
        ...
        <h3 id="content17" className="mb-4 text-xl font-semibold">
        ...
        <h3 id="content18" className="mb-4 text-xl font-semibold">
          18. MISCELLANEOUS
        </h3>
        <p className="mb-4 text-md text-muted-foreground leading-relaxed">
        ...
        <h3 id="content19" className="mb-4 text-xl font-semibold">
          19. CONTACT US
        </h3>
        <p className="mb-4 text-md text-muted-foreground leading-relaxed">
