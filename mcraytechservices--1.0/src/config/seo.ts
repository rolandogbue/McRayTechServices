...
const SEO_CONFIG: Record<string, PageSEO> = {
	home: {
		...
		description:
			"McRay Tech Services is an all-in-one software and digital growth partner based in Abuja, helping small and medium businesses with website development, branding, SEO, digital marketing, and automation to drive faster growth. Save time, cut costs, and grow your business faster today.",
		keywords:
